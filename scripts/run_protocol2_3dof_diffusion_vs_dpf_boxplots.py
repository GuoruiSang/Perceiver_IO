#!/usr/bin/env python3
"""Protocol-2 comparison plots for 3DoF:
...
OUT_ROOT = _env_path("OUT_ROOT", project_root / "output_ablation" / "protocol2_3dof_fixed_diffusion_eval_with_hnn")
...
def make_policy_boxplots():
    ...
    for policy in POLICIES:
        ...
        out = PLOTS_ROOT / f"boxplot_3dof_{policy}_dpf_vs_diffusion_protocol2.png"
