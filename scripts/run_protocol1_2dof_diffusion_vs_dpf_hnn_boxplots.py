#!/usr/bin/env python3
"""Protocol-1 comparison plots for 2DoF:
...
OUT_ROOT = _env_path("OUT_ROOT", project_root / "output_ablation" / "protocol1_2dof_fixed_diffusion_eval_with_hnn")
...
def make_policy_boxplots():
    ...
    for policy in POLICIES:
        ...
        out = PLOTS_ROOT / f"boxplot_2dof_{policy}_dpf_vs_diffusion_protocol1.png"
