...
# ax1.plot(ood_lengths, ood_baseline, 'o-', color=baseline_color, label='Baseline', markersize=5, linewidth=1.5)
...
# ax1.set_ylabel('MSE')
# ax1.set_title('(a) Out-of-Distribution')
# ax1.legend(loc='upper left', framealpha=0.9)
# ax1.set_xlim([0, 1000])
# ax1.set_ylim([0, 0.58])

# # Right plot: In-distribution
# ax2.plot(id_lengths, id_baseline, 'o-', color=baseline_color, label='Baseline', markersize=5, linewidth=1.5)
...
# ax2.set_ylabel('MSE')
# ax2.set_title('(b) In-Distribution')
